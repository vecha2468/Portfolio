      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <p className="text-lg text-text-secondary mb-8 leading-relaxed">
            I'm currently open to new opportunities and collaborations. Whether you have a project in mind,  any relevant job updates, or just want to say hi, my inbox is always open. I'll try my best to get back to you! 
          </p>
          <a
